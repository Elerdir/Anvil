@echo off
REM Pusti agentni smycku (code review) proti skutecnemu modelu s Vulkan akceleraci.
REM   scripts\review.bat D:\models\model.gguf E:\Projects\Anvil [kontext] [zamereni]
...
cargo run --release --example review -p anvil-infrastructure --features engine-vulkan -- %*
set RC=%ERRORLEVEL%
endlocal & exit /b %RC%
